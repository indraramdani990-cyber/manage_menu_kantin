...
// Keamanan: Cari data berdasarkan id DAN user_id penjual yang login
$query = "SELECT * FROM menu WHERE id = '$id' AND user_id = '$user_id'";
$result = mysqli_query($conn, $query);
$data = mysqli_fetch_assoc($result);

// Jika data tidak ditemukan / milik orang lain, sistem menolak
if (!$data) {
...
<body class="pb-12">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-white mb-1">Edit Menu</h1>
            <p class="text-indigo-100">Perbarui informasi menu <span class="font-semibold text-white">"<?= htmlspecialchars($data['nama_menu']); ?>"</span></p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="px-8 py-6 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-gray-100">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-800">Form Edit Menu</h2>
                        <p class="text-sm text-gray-500">Perbarui detail menu sesuai kebutuhan</p>
                    </div>
                </div>
            </div>
            
            <form action="update.php" method="POST" class="p-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_menu" value="<?= htmlspecialchars($data['nama_menu']); ?>" required
                                class="input-focus w-full pl-12 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-amber-500 focus:bg-white transition-all-300" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="kategori_menu" required
                                class="input-focus w-full pl-12 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:border-amber-500 focus:bg-white transition-all-300 appearance-none cursor-pointer">
                                <option value="Makanan" <?= $data['kategori_menu'] == 'Makanan' ? 'selected' : ''; ?>>🍽️ Makanan</option>
                                <option value="Minuman" <?= $data['kategori_menu'] == 'Minuman' ? 'selected' : ''; ?>>🥤 Minuman</option>
                                <option value="Snack" <?= $data['kategori_menu'] == 'Snack' ? 'selected' : ''; ?>>🍿 Snack</option>
                            </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="status_menu" required
                                class="input-focus w-full pl-12 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:border-amber-500 focus:bg-white transition-all-300 appearance-none cursor-pointer">
                                <option value="Tersedia" <?= $data['status_menu'] == 'Tersedia' ? 'selected' : ''; ?>>✅ Tersedia</option>
                                <option value="Habis" <?= $data['status_menu'] == 'Habis' ? 'selected' : ''; ?>>❌ Habis</option>
                            </select>
                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="deskripsi" rows="4"
                            class="input-focus w-full pl-12 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-amber-500 focus:bg-white transition-all-300 resize-none" 
                            placeholder="Jelaskan menu Anda secara singkat (opsional)"><?= htmlspecialchars($data['deskripsi']); ?></textarea>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="tanggal_input" value="<?= $data['tanggal_input']; ?>" required
                            class="input-focus w-full pl-12 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:border-amber-500 focus:bg-white transition-all-300">
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 pt-6 border-t border-gray-100">
                    ...
                    <button type="submit" class="btn-hover px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all-300 flex items-center justify-center space-x-2">
